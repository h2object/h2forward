...
h2forward applicaiton settings

section [forward] is for the applicaiton settings
...
func DefaultCONFIG() *CONFIG {
	...
	default_config.config.AddOption("forward", "appid", appid)
	default_config.config.AddOption("forward", "secret", secret)
	default_config.config.AddOption("forward", "acl.enable", "false")
